...
WebUI.click(findTestObject('TC011/Page_Brivge/button_Order'))

WebUI.click(findTestObject('TC011/Page_Brivge/li_SO Monitoring List'))

WebUI.setText(findTestObject('TC011/Page_Brivge/input_SO Monitoring List'), GlobalVariable.custContractNo)

y = WebUI.getText(findTestObject('TC011/Page_Brivge/div_orderNo'))

CustomKeywords.'util.copyToExcel.exel'(y, 1, 12)
...
WebUI.callTestCase(findTestCase('common/Long Form/11_1 - input basic info'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('common/Long Form/11_2 - input container info'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('common/Long Form/11_3 - input outer package'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('common/Long Form/11_4 - input add parts'), [:], FailureHandling.STOP_ON_FAILURE)
