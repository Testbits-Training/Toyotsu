...
WebUI.setText(findTestObject('Object Repository/Login/input_Sign In_username'), username)
...
WebUI.setText(findTestObject('Object Repository/Login/input_Verify_verificationCode'), verification)
