...
WebUI.setText(findTestObject('TC006/Page_Brivge/input__buyer'), 'VN-TTVN')
...
CustomKeywords.'util.copyToExcel.exel'(outBoundRefNo, 1, 9)
...
CustomKeywords.'util.copyToExcel.exel'(bookingNo, 1, 10)
